...
export default function SalaryMeter({ totalSalary }) {
  ...
  return (
    <div className="font-mono select-none pt-2">
      {/* 💡 改善ポイント：タイトルと総年俸を左右に綺麗に配置。メーターの右上には何も置かない空間を作ります */}
      <div className="flex justify-between items-center mb-10 border-b border-stone-900 pb-2">
      ...
      {/* メーター本体 */}
      <div className="relative w-full h-8 bg-stone-950 rounded-md border border-stone-800 overflow-visible mb-10">
        ...
        {/* 💡 【上側チーム】：TAX と 2nd APRON はメーターの「真上」へ。これで右上のバッジと重なることはありません */}
        ...
        {/* 💡 【下側チーム】：CAP と 1st APRON はメーターの「真下」へ */}
